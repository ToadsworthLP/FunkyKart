package toadsworthlp.funkykart.client.model;
...
public class KartEntityModel extends CompositeEntityModel<KartEntity> {
    ...
    public KartEntityModel(ModelPart root) {
    ...
    public void setAngles(KartEntity kartEntity, float f, float g, float h, float i, float j) {
        setPaddleAngle(kartEntity, 0, this.leftPaddle, f);
        setPaddleAngle(kartEntity, 1, this.rightPaddle, f);
    }
    ...
    private static void setPaddleAngle(KartEntity kartEntity, int sigma, ModelPart part, float angle) {
        float f = kartEntity.interpolatePaddlePhase(sigma, angle);
